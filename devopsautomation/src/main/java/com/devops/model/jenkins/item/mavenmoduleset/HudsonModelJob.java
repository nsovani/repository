 ...
 *       &lt;sequence&gt;
 *         &lt;element name="allBuild" type="{}hudson.model.Run" maxOccurs="unbounded" minOccurs="0"/&gt;
    ...
    extends HudsonModelAbstractItem
{
    ...
    protected List<HudsonModelRun> allBuild;
    ...
    /**
     * Gets the value of the allBuild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the allBuild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAllBuild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<HudsonModelRun> getAllBuild() {
        if (allBuild == null) {
            allBuild = new ArrayList<HudsonModelRun>();
        }
